...
QUOTING RULE — CRITICAL:
EVERY field that contains a comma, quote, or parenthesis MUST be wrapped in double-quotes.
This applies to ALL field types: Title, Description, Tags — not just Acceptance Criteria.
When in doubt, quote the field. A quoted field containing no commas is still valid CSV.

SAFE APPROACH: Quote EVERY Description field and EVERY Tags field unconditionally.
This guarantees correctness regardless of content.

```csv
Work Item Type,Title,Description,Acceptance Criteria,Priority,Story Points,Tags
Epic,[Epic 1 title],"[Epic 1 theme — quote this always]",,,,["[Epic 1 title] — quote this always"]
